...
- [Python wrapper](https://github.com/Rapptz/discord.py)
...
- [Python wrapper](https://github.com/johnwmillr/LyricsGenius)
...
- [Python wrapper](https://github.com/stvn1337/PbScraper)
...
- [Python wrapper](https://github.com/rackspace/pyrax)
...
- [Python wrapper](https://github.com/jaebradley/rotten_tomatoes_client)
...
- [Python wrapper](https://github.com/GearPlug/salesforce-python)
...
- [Python wrapper](https://github.com/scaleway/python-scaleway)
...
- [Python wrapper](https://github.com/Skyscanner/skyscanner-python-sdk)
...
- [Python wrapper](https://github.com/smartfile/client-python)
...
- [Python wrapper](https://github.com/xmunoz/sodapy)
...
- [Python wrapper](https://github.com/3jackdaws/soundcloud-lib)
...
- [Python wrapper](https://github.com/stripe/stripe-python)
...
- [Python wrapper](https://github.com/ianunruh/hvac)

### [Vimeo](https://vimeo.com/) - Video-sharing website
- [API documentation](https://developer.vimeo.com/)
- [Python wrapper](https://github.com/vimeo/vimeo.py)
...
- [Python wrapper](https://github.com/woothemes/wc-api-python)
...
- [Python wrapper](https://github.com/Yelp/yelp-python)
...
- [Python wrapper](https://github.com/deanmcgregor/ynab-python)

### [YouTube](https://www.youtube.com) - Video-sharing website
- [API documentation](https://developers.google.com/youtube/)
- [Python wrapper](https://github.com/rohitkhatri/youtube-python)
